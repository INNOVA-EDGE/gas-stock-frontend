...
const Sidebar = ({ activeItem, onNavigate }) => {
  return (
    <div className={styles.sidebar}>
      {' '}
      {/* styles.sidebar au lieu de "sidebar" */}
      <div className={styles['sidebar-header']}>GAZFLOW</div>{' '}
      {/* styles['sidebar-header'] pour les noms avec tirets */}
      <nav className={styles['sidebar-nav']}>
        <ul>
          <li
            className={`${styles['sidebar-nav-item']} ${
              activeItem === 'accueil' ? styles.active : ''
            }`}
          >
          ...
          <li
            className={`${styles['sidebar-nav-item']} ${
              activeItem === 'stocks' ? styles.active : ''
            }`}
          >
          ...
          <li
            className={`${styles['sidebar-nav-item']} ${
              activeItem === 'ventes' ? styles.active : ''
            }`}
          >
          ...
          <li
            className={`${styles['sidebar-nav-item']} ${
              activeItem === 'versements' ? styles.active : ''
            }`}
          >
          ...
          <li
            className={`${styles['sidebar-nav-item']} ${
              activeItem === 'credits' ? styles.active : ''
            }`}
          >
          ...
          <li
            className={`${styles['sidebar-nav-item']} ${
              activeItem === 'rapports' ? styles.active : ''
            }`}
          >
            <a href='#rapports' onClick={() => onNavigate('rapports')}>
              <FaChartBar className={styles.icon} />{' '}
              <span>Rapports d'Agence</span>
            </a>
          </li>
          <li
            className={`${styles['sidebar-nav-item']} ${
              activeItem === 'profil' ? styles.active : ''
            }`}
          >
          ...
          <li
            className={`${styles['sidebar-nav-item']} ${
              activeItem === 'deconnexion' ? styles.active : ''
            }`}
          >
            <a
              href='#deconnexion'
...
// --- Composant Card (utilisation des styles.nomDeClasse) ---
const DashboardCard = ({
  title,
  value,
  icon,
  ...
  const cardClassName = `${styles['dashboard-card']} ${
    type === 'info' ? styles['overview-card'] : styles['action-card']
  }`
...
// --- Composant Principal du Dashboard Responsable d'Agence (utilisation des styles.nomDeClasse) ---
        ...
        return (
          <div>
            <h1 className={styles['page-header']}>
              Bienvenue, Responsable d'Agence !
            </h1>
            ...
            <div
              className={`${styles['dashboard-section']} ${styles['recent-activities']} ${styles['dashboard-card']}`}
            >
              <p>Tableau ou liste des activités récentes irait ici.</p>
              <ul>
                <li>20/07/2025: Vente à Client A (2 x 6kg)</li>
                <li>19/07/2025: Réception de 50 x 12.5kg</li>
                <li>18/07/2025: Remboursement crédit Client B</li>
              </ul>
            </div>
          </div>
        )
          ...
          <div>
            ...
            <div className={styles['action-cards-container']}>
              <DashboardCard
                ...
                onButtonClick={() =>
                  alert('Ouvrir formulaire Enregistrer Réception')
                }
              />
              <DashboardCard
                type='action'
          ...
          <div>
            ...
            <div className={styles['action-cards-container']}>
              <DashboardCard
                ...
                onButtonClick={() =>
                  alert('Ouvrir formulaire Enregistrer Vente')
                }
              />
              <DashboardCard
                type='action'
          ...
          <div>
            ...
            <div className={styles['action-cards-container']}>
              <DashboardCard
                ...
                onButtonClick={() =>
                  alert('Ouvrir formulaire Enregistrer Versement')
                }
              />
              <DashboardCard
                type='action'
          ...
          <div>
            ...
            <div className={styles['action-cards-container']}>
              ...
              <DashboardCard
                ...
                onButtonClick={() =>
                  alert('Ouvrir formulaire Enregistrer Remboursement')
                }
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className={styles['action-cards-container']}>
              <DashboardCard
                ...
                onButtonClick={() =>
                  alert('Générer Rapport Quotidien des Ventes')
                }
              />
              <DashboardCard
                type='action'
          ...
          <div>
            ...
            >
              ...
              <button
                ...
                onClick={() => alert('Ouvrir page modifier profil')}
              >
                Modifier mon Profil
              </button>
            </div>
      ...
      default:
        return (
          <div>
            ...
            <p>
              Vérifie si le nom de la section dans la sidebar correspond au
              'case' dans le `renderContent`.
            </p>
          </div>
        )
    }
