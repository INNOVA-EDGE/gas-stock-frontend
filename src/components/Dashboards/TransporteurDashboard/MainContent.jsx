    ...
    return (
        <>
            ...
            <div className="history-section">
                ...
                <p className="history-description">Voici un aperçu de vos dernières activités de livraison.</p>

                <ul className="delivery-list">
                    <li className="delivery-item">
                        <div className="delivery-details">
                            <p className="delivery-title">Mission #10123 - Client A</p>
                            <p className="delivery-address">Adresse: 123 Rue de la Livraision, Ville</p>
                            <p className="delivery-status">Statut: <span className="status-delivered">Livrée</span> le 20/07/2025 à 14h30</p>
                        </div>
                    ...
                    <li className="delivery-item">
                        <div className="delivery-details">
                            ...
                            <p className="delivery-address">Adresse: 456 Avenue des Colis, Village</p>
                            <p className="delivery-status">Statut: <span className="status-in-progress">En cours</span> (Départ 21/07/2025)</p>
                        </div>
                        <div className="delivery-actions">
                            <button className="btn btn-details">Voir Détails</button>
                            <button className="btn btn-update-status">MàJ Statut</button>
                            <button className="btn btn-report-anomaly">Signaler Anomalie</button>
                        </div>
                    </li>
                    <li className="delivery-item">
                        <div className="delivery-details">
                            <p className="delivery-title">Mission #10125 - Client C</p>
                            <p className="delivery-address">Adresse: 789 Chemin des Bouteilles, Campagne</p>
                            <p className="delivery-status">Statut: <span className="status-anomaly">Anomalie</span> (Client absent 20/07/2025)</p>
                        </div>
                        <div className="delivery-actions">
                            <button className="btn btn-details">Voir Détails</button>
                ...
                <p className="section-footer-text">Ceci est un aperçu. Pour voir toutes vos missions, utilisez la navigation "Mes Livraisons".</p>
            </div>
        </>
    );
};
